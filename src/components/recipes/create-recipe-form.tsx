...
export function CreateRecipeForm() {
  ...
  const [difficulty, setDifficulty] = useState<"Easy" | "Medium" | "Chef">("Easy");
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok || body.success === false) {
        throw new Error(body.error?.message ?? "Failed to create recipe.");
      }

      setNotification({ tone: "success", message: "Recipe created successfully!" });
    ...
    <div className="mx-auto mt-8 max-w-3xl">
      <div className="panel rounded-[1.75rem] bg-white p-7 shadow-sm">
        <div className="mb-6">
          ...
          <h2 className="section-title">Add to the shelf</h2>
        </div>
